module ApplicationHelper
  ...
  def library_select_form(f, label = "")
    f.input :library,
      ...
      collection: { 'Hesburgh Library' => :hesburgh , 'Architecture Library' => :architecture, 'Chemistry - Physics Library' => :chem, 'Mahaffey Business Library' => :business, 'O\' Meara Mathematics Library' => :math, 'Music Library' => :music },
      :default => 'Hesburgh',
      label: label
  end
