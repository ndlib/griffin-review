class FixElectronicReserves
  ...
  def fix!
    ...
    Item.update_all('electronic_reserve = 0', 'type = "VideoReserve" AND physical_reserve = 1 ')
    Item.update_all('electronic_reserve = 0', 'type = "AudioReserve" AND physical_reserve = 1 ')
