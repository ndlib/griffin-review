class Reserve
  ...
  delegate :currently_in_aleph, :currently_in_aleph?, :reviewed?, :reviewed, :created_at, :updated_at, :id, :semester, :workflow_state, :course_id, :crosslist_id, :requestor_netid, :needed_by, :number_of_copies, :note, :requestor_owns_a_copy, :library, :requestor_netid, :required_material, to: :request
  delegate :currently_in_aleph=, :reviewed=, :id=, :semester=, :workflow_state=, :course_id=, :requestor_netid=, :needed_by=, :number_of_copies=, :note=, :requestor_owns_a_copy=, :library=, :requestor_netid=, :required_material=, to: :request
