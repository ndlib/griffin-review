...
describe GetListingsController do
  ...
  describe :show do
    ...
    context 'requires copy right acceptance' do
      before(:each) do
        BookChapterListing.any_instance.stub(:approval_required?).and_return(true)
      end
      ...
      it "downloads the item if the copyright accepetance has been accepted and it is a download item" do
        BookChapterListing.any_instance.stub(:file).and_return("FILE")
      ...
      it "redirects if the copyright acceptance has has been accepted and it is a redirect item" do
        BookChapterListing.any_instance.stub(:url).and_return("http://www.google.com")
        BookChapterListing.any_instance.stub(:file).and_return(nil)
    ...
    context ' it does not requre copyright acceptance' do
      before(:each) do
        BookChapterListing.any_instance.stub(:approval_required?).and_return(false)
      end
