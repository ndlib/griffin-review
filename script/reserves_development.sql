...
INSERT INTO `metadata_attributes` VALUES (1,'Runtime','The length of the video','2012-09-07 20:27:54','2012-09-07 20:27:54');
...
INSERT INTO `roles` VALUES (1,'Administrator','This role allows the user to create and update most objects in the system.','2012-06-25 15:43:44','2012-06-25 15:55:23'),(2,'Reserves Technician','The reserves technician can add and update courses, items, and student permissions.','2012-06-25 15:44:45','2012-06-25 15:44:45'),(3,'Faculty','A teaching or research faculty member of the university.','2012-07-31 19:37:44','2012-07-31 19:37:44'),(4,'Staff','A person who works for the University as a staff person.','2012-08-31 21:56:09','2012-08-31 21:56:09'),(5,'Graduate Student','A student who is enrolled in a graduate course of studies at the University','2012-08-31 21:59:59','2012-08-31 21:59:59'),(6,'Undergraduate Student','A student who is enrolled in an undergraduate course of studies at the University.','2012-08-31 22:00:30','2012-08-31 22:00:30'),(7,'Media Admin','A person responsible for the digitization of multimedia materials that are incorporated into the reserves system. ','2012-09-09 17:32:19','2012-09-09 17:32:19');
DROP TABLE IF EXISTS `schema_migrations`;
CREATE TABLE `schema_migrations` (
  `version` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  UNIQUE KEY `unique_schema_migrations` (`version`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
INSERT INTO `schema_migrations` VALUES ('20120618210515'),('20120621182135'),('20120621185142'),('20120706195736'),('20120710151041'),('20120723202005'),('20120816162945'),('20120820183857'),('20120820184700'),('20120905133021'),('20120905190330'),('20120905190442');
...
CREATE TABLE `technical_metadata` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `vw_id` int(11) DEFAULT NULL,
  `ma_id` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
INSERT INTO `technical_metadata` VALUES (1,10,1,'2012-09-09 15:46:14','2012-09-09 15:46:14');
...
INSERT INTO `users` VALUES (4,'Robert','Fox','Robert Fox','rfox2@nd.edu',28,'2012-09-09 17:31:11','2012-09-09 17:29:49','127.0.0.1','127.0.0.1','rfox2','2012-06-20 18:16:36','2012-09-09 17:31:11'),(5,'Tom','Hanstra','Tom Hanstra','hanstra@nd.edu',0,NULL,NULL,NULL,NULL,'hanstra','2012-06-25 19:09:18','2012-06-25 19:09:18');
